...
import RequestTypeSettings from './pages/RequestTypeSettings';
import ProjectSettings from './pages/ProjectTypeSettings';
import { token } from '@atlaskit/tokens';
import SynchronizationLogs from './pages/SynchronizationLogs.tsx';
...
function App() {
    ...
    useEffect(() => {
        view.createHistory().then(
            (newHistory: import('history').History | null) => {
